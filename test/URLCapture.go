...
// URLCaptureMatch holds the result of a successful match with capture groups.
...
Ins22:
	{
		captures[1] = offset
		return &URLCaptureMatch{Match: string(input[captures[0]:captures[1]]), Start: captures[0], End: captures[1], Protocol: func() string {
