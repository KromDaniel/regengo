...
Usage:
    go test -bench=. -benchmem ./benchmarks/generated/ 2>&1 | python scripts/benchmark_chart.py
...
def generate_chart(results: dict, output_path: str = "assets/benchmark_chart.png"):
